...
def init_module (module_name, package_name):
    ...
    if not mv (make_path (ModulePaths.SrcAndroidTest, Files.AndroidTest), 
               androidtest_src) \
    ...
    # Update the .java/.kt files with the new module's package
    echo_va ("Updating $[0] and $[1] ...", Files.AndroidTest, Files.Test)
